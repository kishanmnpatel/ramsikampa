        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('surname.update',$surname->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-input id="gujarati_word" class="block mt-1 w-full" type="text" name="gujarati_word" value="{{$surname->gujarati_word}}" required autofocus />
                        </div>
                        <br>
                        <!-- Englush Word -->
                        <div>
                            <x-label for="english_word" :value="__('English Word')" />
                            <x-input id="english_word" class="block mt-1 w-full" type="text" name="english_word" value="{{$surname->english_word}}" required/>
                        </div>
