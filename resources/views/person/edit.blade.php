                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('person.update',$person->id) }}">
                        ...
                        <div>
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$person->name" required autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="surname" name="surname_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected="">Choose a surname</option>
                                @foreach ($surnames::all() as $surname)
                                    <option value="{{$surname->id}}" {{$person->surname->english_word == $surname->english_word ? 'selected' : ''}}>{{$surname->gujarati_word}}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- mobile -->
                        <div class="mt-4">
                            ...
                            <x-input id="mobile" class="block mt-1 w-full" type="text" name="mobile" :value="$person->mobile"/>
                        </div>

                        <!-- address -->
                        <div class="mt-4">
                            <x-label for="address" :value="__('Address')" />
                            <x-input id="address" class="block mt-1 w-full" type="text" name="address" :value="$person->address" required/>
                        </div>

                        <!-- age -->
                        <div class="mt-4 w-48">
                            <x-label for="age" :value="__('Age')" />
                            <x-input id="age" class="block mt-1 w-full" type="number" name="age" :value="$person->age" required/>
                        </div>
                            ...
                            <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="female" type="radio" value="female" name="gender" {{$person->gender == 'female' ? 'checked' : ''}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="female" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Female</label>
                                    </div>
                                </li>
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="male" type="radio" value="male" name="gender" {{$person->gender == 'male' ? 'checked' : ''}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        ...
                        <input type='hidden' value='{{$person->relation == $person::SELF ? '0' : $person->parent->id}}' name='parent_id' id="parent_id">
                        ...
                        <div id="selectedParentName" class="text-green">{{$person->relation == $person::SELF ? '' : $person->parent->name.' '.$person->parent->surname->english_word}}</div>
                        ...
                        <div class="mt-4 w-[26rem]">
                            ...
                            <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="self" type="radio" value="{{$person::SELF}}" {{$person->relation == $person::SELF ? 'checked' : ''}} name="relation" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="self" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Self</label>
                                    </div>
                                </li>
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="father" type="radio" value="{{$person::FATHER}}" {{$person->relation == $person::FATHER ? 'checked' : ''}} name="relation" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="father" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Father</label>
                                    </div>
                                </li>
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="husbund" type="radio" value="{{$person::HUSBUND}}" {{$person->relation == $person::HUSBUND ? 'checked' : ''}} name="relation" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="husbund" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Husbund</label>
                                    </div>
                                </li>
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="wife" type="radio" value="{{$person::WIFE}}" {{$person->relation == $person::WIFE ? 'checked' : ''}} name="relation" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        ...
                        <div class="flex items-center mb-4 mt-4">
                            ...
                            <input id="is_daughter" type="checkbox" {{$person->is_daughter == 'true' ? 'checked' : ''}} value="true" name="is_daughter" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center mb-4 mt-4">
                            ...
                            <input id="is_married" type="checkbox" {{$person->is_married == 'true' ? 'checked' : ''}} value="true" name="is_married" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center mb-4 mt-4">
                            ...
                            <input id="is_died" type="checkbox" {{$person->is_died == 'true' ? 'checked' : ''}} value="true" name="is_died" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
